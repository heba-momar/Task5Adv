...
const FormItem =forwardRef <HTMLFormElement,ItemForm> (({TittelForm,inputs,onSubmit,image,initialImage},ref) => {  
      ...
      <Form onSubmit={onSubmit} >
        <div className="d-flex gap-5 align-items-start flex-wrap flex-lg-nowrap">
          ...
          <FormGroup className="mb-3" controlId={`formInput${index}`}>
             ...
             <Form.Control type={input.type} placeholder={input.placeholder} className='rounded-1 w-75'defaultValue={input.defaultValue} ref={input.ref}/>
          </FormGroup>     
                )
             })}
            </div>
           ...
           <div className="flex-fill">
            ...
            <ImageUplood  addNewItem="imageBox rounded-1" ref={image} initialImage={initialImage}/>                  
                    </div>
        </div>
        {/*Button save */}
           <Row>
